...
public class AdminStaff extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Table1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sl No.", "Staff_Name", "Username", "Password"
            }
        ));
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addComponent(pswd, javax.swing.GroupLayout.PREFERRED_SIZE, 205, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void Table1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Table1MouseClicked
        ...
        uname.setText(d1.getValueAt(selectIndex, 2).toString());
        pswd.setText(d1.getValueAt(selectIndex, 3).toString());
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        try{
            ...
            String sql = "insert into staff(name,username,password)values('"+Name+"','"+Uname+"','"+Pswd+"')";
            System.out.println(sql);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
        {
            Class.forName("com.mysql.cj.jdbc.Driver");
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/sheduler","root","");
            String sql="update staff set name ='"+Name+"',username ='"+Uname+"',password ='"+Pswd+"' WHERE sl_no='"+id+"'";
            System.out.println(sql);
            Statement stmt=con.createStatement();
            int rs = stmt.executeUpdate(sql);
            System.out.println(rs);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(dialogResult==JOptionPane.YES_OPTION)
        {
            try{
                ...
                String sql = "Delete from staff where sl_no= '"+id+"' ";
